---
name: earnings-workflow
description: 分析季度财报并生成财报点评。
---
...
This is the Codex-native equivalent of the upstream `/earnings` slash command. If arguments are missing, ask only for the information needed to continue.
