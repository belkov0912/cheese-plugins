...
This is the Codex-native equivalent of the upstream `/comps` slash command. If arguments are missing, ask only for the information needed to continue.
